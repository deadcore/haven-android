...
public class FilterProfessionalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filter_professional);
        ...
        getSupportActionBar().setTitle("Give support");
